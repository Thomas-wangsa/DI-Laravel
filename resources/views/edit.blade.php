              ...
              <div class="col-md-8 col-md-offset-2">
                  <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                          ...
                          <form class="form-horizontal" action="/edit_post" method="post">
                            {{ csrf_field() }}
                            <input class="date form-control" type="hidden" name="uuid"
                                required="required" value="{{$data->uuid}}">
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="date"> Date :</label>
                              <div class="col-sm-10">
                                <input class="date form-control" type="text" name="date"
                                required="required" value="{{$data->date}}" disabled="disabled">
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-10"> 
                                ...
                                required="required" value="{{$data->max}}">
                              </div>
                            </div>
                            <div class="form-group">
                              ...
                              <div class="col-sm-10"> 
                                ...
                                required="required" value="{{$data->min}}">
                              </div>
                            </div>
                            <div class="form-group"> 
